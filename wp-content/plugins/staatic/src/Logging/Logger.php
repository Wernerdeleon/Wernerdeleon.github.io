...
final class Logger implements \Staatic\WordPress\Logging\LoggerInterface
{
    ...
    public function __construct(PsrLoggerInterface $databaseLogger, PsrLoggerInterface $consoleLogger, string $minimumLevel = LogLevel::DEBUG, bool $consoleLoggerEnabled = \false, bool $databaseLoggerEnabled = \true)
    {
