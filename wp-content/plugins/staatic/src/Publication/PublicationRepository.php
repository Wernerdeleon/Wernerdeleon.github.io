...
final class PublicationRepository implements LoggerAwareInterface
{
    ...
    public function __construct(wpdb $wpdb, BuildRepository $buildRepository, DeploymentRepository $deploymentRepository, WorkDirectorySetting $workDirectory, Filesystem $filesystem, string $tableName = 'staatic_publications')
    {
        $this->wpdb = $wpdb;
