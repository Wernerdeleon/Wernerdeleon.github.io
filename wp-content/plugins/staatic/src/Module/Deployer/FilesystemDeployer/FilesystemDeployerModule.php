...
final class FilesystemDeployerModule implements ModuleInterface
{
    ...
    public function __construct(Settings $settings, ServiceLocator $settingLocator, FilesystemDeployStrategyFactory $deployStrategyFactory, ResultRepositoryInterface $resultRepository, ResourceRepositoryInterface $resourceRepository)
    {
    ...
    public function overrideExcludeUrls(array $excludeUrls, UriInterface $baseUrl) : array
    {
        if (\get_option('staatic_filesystem_symlink_uploads')) {
            $excludeRule = Filesystem::getRelativeUploadsPath() . '*';
    ...
    public function overrideTransformers(array $transformers) : array
    {
    ...
    public function validateDeploymentStrategy(array $errors) : array
    {
