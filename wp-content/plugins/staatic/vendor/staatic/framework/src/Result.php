...
final class Result
{
     ...
     */
    private $dateCreated;
    public function __construct(string $id, string $buildId, UriInterface $url, int $statusCode, ?string $md5 = null, ?string $sha1 = null, ?int $size = null, ?string $mimeType = null, ?string $charset = null, $redirectUrl = null, $originalUrl = null, $originalFoundOnUrl = null, ?DateTimeInterface $dateCreated = null)
    {
        $this->id = $id;
