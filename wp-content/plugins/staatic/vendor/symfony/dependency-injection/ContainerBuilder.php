...
use Staatic\Vendor\Symfony\Component\DependencyInjection\Argument\LazyClosure;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
     ...
     */
    public function deprecateParameter($name, $package, $version, $message = 'The parameter "%s" is deprecated.') : void
    {
     ...
     * @param string $message
     */
    public function log($pass, $message) : void
    {
